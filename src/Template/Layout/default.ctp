...
<head>
    ...
    <!-- Cambio del ícono -->
    <?= $this->Html->meta('and_4463.ico','/and_4463.ico',['type' => 'icon'])    ?>

    <!-- Espacio donde se cargan los archivos pertinentes a bootstrap, js y demás estilos-->
...
<body>
    ...
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      ...
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Sistema de ejemplo</a>
