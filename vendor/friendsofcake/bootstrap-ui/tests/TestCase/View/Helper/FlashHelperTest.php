...
class FlashHelperTest extends TestCase
{
    ...
    public function testRender()
    {
        ...
        $this->assertContains('<div role="alert" class="alert hola alert-dismissible fade in alert-info">', $result);
        ...
        $this->assertContains('<div role="alert" class="alert hola alert-dismissible fade in alert-danger">', $result);
        $this->assertContains('<button type="button" class="close" data-dismiss="alert" aria-label="Close">', $result);
